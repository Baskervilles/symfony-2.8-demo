        ...
        <div class="search">
            <form method="get" action="http://symfony.com/search">
                <div class="form-row">
                    ...
                    <input name="q" id="search-id" type="search"
        ...
        <div class="block">
            <div class="symfony-block-content">
                ...
                <?php if (count($majorProblems)): ?>
                    ...
                    <p>Major problems have been detected and <strong>must</strong> be fixed before
                        continuing:</p>
                    <ol>
                ...
                <?php if (count($minorProblems)): ?>
                    ...
                    <p>
                        <?php if (count(
                            $majorProblems
                        )): ?>Additionally, to<?php else: ?>To<?php endif; ?> enhance your Symfony
                        experience,
                ...
                <?php if ($symfonyRequirements->hasPhpIniConfigIssue()): ?>
                    <p id="phpini">*
                        <?php if ($symfonyRequirements->getPhpIniConfigPath()): ?>
                            ...
                            <strong><?php echo $symfonyRequirements->getPhpIniConfigPath(
                                ) ?></strong>".
                        <?php else: ?>
                ...
                <?php if (!count($majorProblems) && !count($minorProblems)): ?>
                    <p class="ok">All checks passed successfully. Your system is ready to run
                        Symfony applications.</p>
                <?php endif; ?>
